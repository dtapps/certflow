...
const (
	// Label holds the string label denoting the ca type in the database.
	Label = "ca"
	...
	// Table holds the table name of the ca in the database.
	Table = "cas"
	...
	CertificatesColumn = "ca_certificates"
)

// Columns holds all SQL columns for ca fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldDirectoryURL,
...
// OrderOption defines the ordering options for the CA queries.
