  ...
  <div class="login-overlay" :style="overlayStyle" style="animation: var(--animate-fade-in)">
    ...
    <div class="login-card" :style="cardStyle" style="animation: var(--animate-fade-in-scale)">
      ...
      <div class="text-center mb-6">
        <div class="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4" :style="{ backgroundColor: isDark ? 'rgba(59, 130, 246, 0.2)' : 'rgba(59, 130, 246, 0.1)' }">
      ...
      <!-- 主题 & 语言切换 -->
      <div class="flex items-center justify-center gap-2 mt-6 pt-4 border-t" :style="{ borderColor: isDark ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)' }">
        <n-button
          quaternary
          size="small"
          @click="toggleTheme"
        ...
        >
          ...
          {{ theme === 'dark' ? t('theme.dark') : theme === 'light' ? t('theme.light') : t('theme.auto') }}
        </n-button>
